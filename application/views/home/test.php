	...
	<div class="wesley_tm_content">
				...
				<div class="content hero">
					<div class="container hero">
						<div class="wesley_tm_hero_title">
							<h5>Looking For a Designer...?</h5>
							<p class="name">Here I'm <span>Wesley</span></p>
					...
					<div class="author_wrap">
						...
						<div class="rightbox">
							...
							<div class="buttons_wrap">
								<ul>
									<li>
										<a class="download" href="index.html"><span>Download CV</span></a>
									</li>
									<li class="anchor">
		...
		<div class="wesley_tm_footer_total_wrap">
			...
			<div class="wesley_tm_footer_wrap">
				<p class="wow fadeIn"  data-wow-duration="1.2s">&copy; Copyright 2018. Theme designed by <a href="https://themeforest.net/user/marketify">Marketify</a></p>
			</div>
		</div>
		<!-- /FOOTER -->
